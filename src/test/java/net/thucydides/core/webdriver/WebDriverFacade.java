...
public class WebDriverFacade implements WebDriver, TakesScreenshot, HasInputDevices, JavascriptExecutor, HasCapabilities, ConfigurableTimeouts {
    ...
    private Object proxiedWebDriverCreationMonitor = new Object();

    private static final Logger LOGGER = LoggerFactory.getLogger(net.thucydides.core.webdriver.WebDriverFacade.class);
    ...
    public WebDriverFacade(final Class<? extends WebDriver> driverClass,
        ...
        LOGGER.error("new WebDriverFacade1-" + this.hashCode(), new Exception());
    ...
    public WebDriverFacade(final WebDriver driver,
        ...
        this.environmentVariables = environmentVariables;
        this.implicitTimeout = defaultImplicitWait();
        LOGGER.error("new WebDriverFacade2", new Exception());
    }
    ...
    public WebDriverFacade(final Class<? extends WebDriver> driverClass,
        ...
        LOGGER.error("new WebDriverFacade3" , new Exception() );
    }


    public net.thucydides.core.webdriver.WebDriverFacade withTimeoutOf(Duration implicitTimeout) {
        return new net.thucydides.core.webdriver.WebDriverFacade(driverClass, webDriverFactory, proxiedWebDriver, implicitTimeout);
    }
    ...
    public WebDriver getProxiedDriver() {
        LOGGER.error("getProxiedDriver-" + this.hashCode() + " " + proxiedWebDriver);
        synchronized(proxiedWebDriverCreationMonitor) {
            if (proxiedWebDriver == null) {
                LOGGER.error("getProxiedDriver-" + this.hashCode() + " beforeCreate");
                proxiedWebDriver = newProxyDriver();
                LOGGER.error("getProxiedDriver-" + this.hashCode() + " afterCreate");
                LOGGER.error("getProxiedDriver-" + this.hashCode() + " created  " + proxiedWebDriver);
    ...
    public void reset() {
        ...
        LOGGER.error("setProxiedDriver-" + this.hashCode() + " " + "null2");
    }
    ...
    private void forcedQuit() {
        try {
            ...
            proxiedWebDriver = null;
            LOGGER.error("XXsetProxiedDriver-" + this.hashCode() + " " + "null3");
    ...
    private WebDriver newDriverInstance() {
        try {
            ...
            e.printStackTrace();
            throw new UnsupportedDriverException("YYY Could not instantiate " + driverClass + e.getMessage()
...
//    }
    ...
    public void quit() {
        if (proxyInstanciated()) {
            ...
            LOGGER.error("setProxiedDriver-" + this.hashCode() + " " + "null1");
            proxiedWebDriver = null;
        }
    }
    ...
    public net.thucydides.core.webdriver.WebDriverFacade withOptions(String options) {
