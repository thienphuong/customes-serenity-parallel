...
public class WebDriverFactory {
    private static final Logger LOGGER = LoggerFactory.getLogger(net.thucydides.core.webdriver.WebDriverFactory.class);
    ...
    protected  WebDriver newWebdriverInstance(final Class<? extends WebDriver> driverClass,
        ...
        LOGGER.error("getProxiedDriver-" + this.hashCode() + " newWebdriverInstance " + driverClass);
        //Thread.dumpStack();
        //7RedimensionBrowser redimensionBrowser = new RedimensionBrowser(environmentVariables);
        try {
            ...
            LOGGER.error("getProxiedDriver-" + this.hashCode() + " create driver " + driver);
            setImplicitTimeoutsIfSpecified(driver);
            //redimensionBrowser.withDriver(driver);
            LOGGER.error("getProxiedDriver-" + this.hashCode() + " beforeCloseWhenTheTestsarefinished " + driver);
            //closeBrowser.closeWhenTheTestsAreFinished(driver);
            System.out.println("XXXNewDriverInstance returnedDriver" + driver);
            return driver;
